...
function Restaurant() {
  ...
  let getRestaurantDetails = async () => {
    let url =
      "https://zomato-app-clone.onrender.com/api/get-restaurant-details/" + id;
    let { data } = await axios.get(url);
    setRDetails(data.result);
  };
  let getMenuItemList = async () => {
    let url =
      "https://zomato-app-clone.onrender.com/api/get-menu-item-list/" + id;
    let { data } = await axios.get(url);
  ...
  let getPaymentView = async () => {
    const url = "https://zomato-app-clone.onrender.com/api/create-order";
    ...
    let options = {
      ...
      handler: async function (response) {
        ...
        let url = "https://zomato-app-clone.onrender.com/api/verify-payment";
