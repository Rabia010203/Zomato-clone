...
function Search() {
  ...
  const fetchProductsByPagination = async () => {
    try {
      const { data } = await axios.get(
        `https://zomato-app-clone.onrender.com/api/Pagination`
      );
  ...
  let getLocationList = async () => {
    try {
      let url = "https://zomato-app-clone.onrender.com/api/get-location-list";
  ...
  let getFilterDetails = async () => {
    let url = "https://zomato-app-clone.onrender.com/api/filter";
  ...
  const handlePriceRangeChange = async (event) => {
    ...
    try {
      const { data } = await axios.post(
        `https://zomato-app-clone.onrender.com/api/filterPrice?priceRange=${selectedRange}`
      );
      setRestaurantList(data.products);
    } catch (error) {
      console.error("Error fetching products:", error);
